...
var Config = {
    ...
    publicDirJs : path.join(InstallationDir,'public/vendor/mcms/events/js'),
    publicDirCss : path.join(InstallationDir,'public/vendor/mcms/events/css'),
    publicDirImg : path.join(InstallationDir,'public/vendor/mcms/events/img'),
    publicDirTemplates : path.join(InstallationDir,'public/vendor/mcms/events/app/templates')
};
